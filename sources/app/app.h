...
#define GW_WEBRTC_TRY_CONNECT_SOCKET_INTERVAL				(3000)	 /* 10s */
...
// #ifdef TEST_USE_WEB_SOCKET
	...
	GW_WEBRTC_SIGNALING_OVER_WEBSOCKET_REQ,
// #endif
...
/*****************************************************************************/
/* define timer */
#define GW_RECORD_MAX_RECORDING_INTERVAL (60000 * 3)
...
enum {
	...
	GW_RECORD_INIT = AK_USER_DEFINE_SIG,
	GW_RECORD_ON_MOUNTED,
	GW_RECORD_ON_REMOVED,
	GW_RECORD_PREPARE,
	GW_RECORD_START,
	GW_RECORD_CLOSE,
	GW_RECORD_FORMAT_CARD_REQ,
	GW_RECORD_ADD_METADATA,
	GW_RECORD_UPDATE_INDEX_DATABASE,
